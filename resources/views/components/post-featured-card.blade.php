                ...
                <div class="flex-1 flex flex-col justify-between">
                    <header class="mt-8 lg:mt-0">
                        <div class="space-x-2">
                            <a href="#"
                               ...
                               style="font-size: 10px">تکنیک ها</a>

                            <a href="#"
                               class="px-3 py-1 border border-red-300 rounded-full text-red-300 text-xs uppercase font-semibold"
                               style="font-size: 10px">آپدیت ها</a>
                        </div>

                        <div class="mt-4">
                            <h1 class="text-3xl">
                                این یک عنوان بزرگ برای نمایش است که اگر تا دو یا سه خط آنرا تایپ کنید زیبا تر میشود,
                                واوو!
                            </h1>

                            <span class="mt-2 block text-gray-400 text-xs">
                                        تاریخ انتشار <time>1 روز پیش</time>
                                    </span>
                        </div>
                    </header>
                    ...
                    <footer class="flex justify-between items-center mt-8">
                        <div class="flex items-center text-sm">
                            ...
                            <div class="mx-3">
                                <h5 class="font-bold">میلاد رحیمی</h5>
                                <h6>برنامه نویس جونیور</h6>
                            </div>
                        </div>
